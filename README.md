...
- `assets/` — images (downloaded from the old Squarespace CDN) + `site.css` (shared stylesheet for homepage/benefit/common-app; families & fly-ins pages are self-contained)
